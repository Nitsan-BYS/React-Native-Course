      ...
      <DismissKeyboard>
       <View style={styles.rootContainer}>
        ...
        <View style={styles.textPart}>
          <Text>להתחברות לאפליקציית אמדוקס אנא הזינו את מספר הטלפון והאימייל שלכם</Text>
            <View>
              ...
              <View style={styles.container}>
                  <View style={styles.sectionStyle}>
                    <TextInput
                      ...
                      value={text}
                    />
                    <Image source={require('./assets/callSquare.png')} style={styles.imageStyle} />
                </View>
                <View style={styles.sectionStyle}>
                    <TextInput
                      style={styles.input}
                    ...
                    />
                  <Image source={require('./assets/messageSquare.png')} style={styles.imageStyle}/>
                </View>
              </View>
              {/* </DismissKeyboard>  */}
            </View>
            <View style={styles.secondComponent}>
              ...
              <TouchableOpacity onPress={() =>
                ...
                <LinearGradient
                  ...
                  >
                  <Image style={styles.arrow} source={require('./assets/login-button-arrow.png')}/>
                </LinearGradient>
              </TouchableOpacity>
              </View>
            </View>
